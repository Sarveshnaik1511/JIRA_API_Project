...
public class UpdateUserStory {
    ...
    public void updateUserStory() throws IOException, ParseException {
        ...
        // to update user story, we need to have a file of update credentials
        // we will read the file using below classes and methods
        ...
        // we will update it using crud and RestAssured principle / methods
        Response response= RestAssured.given().baseUri("http://localhost:8080").body(jsonBody).contentType(ContentType.JSON).header("Cookie",cookie)
